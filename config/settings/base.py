...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "attendance.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""injang""", "zx0025@naver.com")]
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentation of API endpoints of attendance",
    "VERSION": "1.0.0",
    "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
    "SERVERS": [
        {"url": "http://127.0.0.1:8000", "description": "Local Development server"},
        {"url": "https://attendance.com", "description": "Production server"},
    ],
}
# Your stuff...
# ------------------------------------------------------------------------------
